...
O speech_10words_resnet_pytorch - my test code
...
speech commands?(RN-50, Jasper) speech synthesis(杯失)?(Tacotron2, WaveNet・) machine translation?(GNMT, Transformer, ConvS2S, ・)
