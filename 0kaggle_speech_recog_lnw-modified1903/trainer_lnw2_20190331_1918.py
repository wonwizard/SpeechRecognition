...
labels = ['vocchild', 'vocfemale', 'vocmale', 'vocold', '5', '6', '7', '8', '9', '10']
...
for e in range(epochs):
    ...
    # 훈련 데이터에서의 정확률을 기록한다
    print("training accuracy:", 100. * total_correct / num_labels,"total:" ,total_correct, "correct:",num_labels,"loss:",round(loss.item(),5), get_time(time(), start_time),"min")
