...
epochs = 50  # 모델이 훈련 데이터를 학습하는 횟수를 지정한다
...
labels = ['do000', 'do060', 'do120', 'do180', 'drone', '6', '7', '8', '9', '10']
...
reporttxt = "epoch,loss,total_accu,"+labels[0]+","+labels[1]+","+labels[2]+","+labels[3]+","+labels[4]+",time(min)\n"
...
for e in range(epochs):
    ...
    if mode == 'cv':
        ...
        print("cv accuracy:",num_totalval,cv_accuracy,"%",labels[0],num_total01,cv_accuracy01,"%",labels[1],num_total02,cv_accuracy02,"%",labels[2],num_total03,cv_accuracy03,"%",labels[3],num_total04,cv_accuracy04,"%",labels[4],num_total05,cv_accuracy05,"%", get_time(time(), start_time),"min")
        ...
        reporttxt = str(e)+","+str(round(loss.item(),5))+","+str(cv_accuracy)+","+str(cv_accuracy01)+","+str(cv_accuracy02)+","+str(cv_accuracy03)+","+str(cv_accuracy04)+","+str(cv_accuracy05)+","+str(get_time(time(), start_time))+"\n" 
        reportfile.write(reporttxt)
        reportfile.close()
