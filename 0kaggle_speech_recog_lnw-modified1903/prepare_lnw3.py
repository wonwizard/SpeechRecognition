...
trndata1_path = data_path+'/train/'+labels[0]
trndata2_path = data_path+'/train/'+labels[1]
trndata3_path = data_path+'/train/'+labels[2]
trndata4_path = data_path+'/train/'+labels[3]
trndata5_path = data_path+'/train/'+labels[4]
trndata6_path = data_path+'/train/'+labels[5]
trndata7_path = data_path+'/train/'+labels[6]
trndata8_path = data_path+'/train/'+labels[7]
trndata9_path = data_path+'/train/'+labels[8]
trndata10_path = data_path+'/train/'+labels[9]
valdata1_path = data_path+'/val/'+labels[0]
valdata2_path = data_path+'/val/'+labels[1]
valdata3_path = data_path+'/val/'+labels[2]
valdata4_path = data_path+'/val/'+labels[3]
valdata5_path = data_path+'/val/'+labels[4]
valdata6_path = data_path+'/val/'+labels[5]
valdata7_path = data_path+'/val/'+labels[6]
valdata8_path = data_path+'/val/'+labels[7]
valdata9_path = data_path+'/val/'+labels[8]
valdata10_path = data_path+'/val/'+labels[9]
prepared_trndata1_path= data_path+'/input/train/'+labels[0]
prepared_trndata2_path= data_path+'/input/train/'+labels[1]
prepared_trndata3_path= data_path+'/input/train/'+labels[2]
prepared_trndata4_path= data_path+'/input/train/'+labels[3]
prepared_trndata5_path= data_path+'/input/train/'+labels[4]
prepared_trndata6_path= data_path+'/input/train/'+labels[5]
prepared_trndata7_path= data_path+'/input/train/'+labels[6] 
prepared_trndata8_path= data_path+'/input/train/'+labels[7]
prepared_trndata9_path= data_path+'/input/train/'+labels[8]
prepared_trndata10_path= data_path+'/input/train/'+labels[9]
prepared_valdata1_path= data_path+'/input/val/'+labels[0]
prepared_valdata2_path= data_path+'/input/val/'+labels[1]
prepared_valdata3_path= data_path+'/input/val/'+labels[2]
prepared_valdata4_path= data_path+'/input/val/'+labels[3]
prepared_valdata5_path= data_path+'/input/val/'+labels[4]
prepared_valdata6_path= data_path+'/input/val/'+labels[5]
prepared_valdata7_path= data_path+'/input/val/'+labels[6]
prepared_valdata8_path= data_path+'/input/val/'+labels[7]
prepared_valdata9_path= data_path+'/input/val/'+labels[8]
prepared_valdata10_path= data_path+'/input/val/'+labels[9]
...
def wavSlice(infileName,insaveDir,insliceTime):
   ...
   #20190505 add 4 shift resave
   shiftTimeList = [200,600,800,900]
   for sti in shiftTimeList :
     x=int(fpms*sti) # fpms : frames per ms
     while x+sliceNumFrames<=numFrames:
       curFrames= frames[x:x+sliceNumFrames]
       x=x+sliceNumFrames
       infileName=infileName.split('/')[-1]
...
if not os.path.exists(data_path+'/input'):
    ...
    os.mkdir(data_path+'/input/train')
    os.mkdir(data_path+'/input/val')
else :
